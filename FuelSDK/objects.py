...
########
##
##  wrap an Exact Target EmailSendDefinition
##
########
...
class ET_Send(ET_CUDSupport):
    ...
    def send(self):
        tscall = self.props
        self.obj = ET_Post(self.auth_stub, "Send", tscall)
        return self.obj

########
##
##  wrap an Exact Target Send Classification
##
########
class ET_FilterDefinition(ET_CUDSupport):
    def __init__(self):
        super(ET_FilterDefinition, self).__init__()
        self.obj_type = 'FilterDefinition'
...
########
##
##  wrap an Exact Target SendDefinitionList
##
########
class ET_SendDefinitionList(ET_CUDSupport):
    def __init__(self):
        super(ET_SendDefinitionList, self).__init__()
        self.obj_type = 'SendDefinitionList'
